...
const calcSlotY =function(){ return canvas.height - 60 + (50 - slotSize)/2;}
const calcDistBetweenSlots = function(){return ((canvas.width * 2/4) - (5 + slotSize)*2)/getInventorySize()};
player.inventory = {
	x:		canvas.width * 1/4,
	y:		canvas.height - 60,
...
player.inventory.clear =	function(){
